...
function Form() {
  ...
  return (
    <View style={[styles.container]}>
      <TouchableOpacity style={[styles.LoginButton, { backgroundColor: '#262626' }]} onPress={() => navigation.navigate('phoneLogin')}>
      ...
      <TouchableOpacity style={[styles.SignButton]} onPress={() => navigation.navigate('Signup', { isOauth: '0', tab: '타입' })}>
